...
biophys.var_sh=function(Temat, D, delta, alpha){
...
Ta_sh= Temat[2]
TaK_sh= Ta_sh+273 #ambient temperature in K
Tg= Temat[3]+273 #C, T_g- ground surface temperature
Tg_sh= Temat[4]+273 #C, T_g- ground surface temperature
u= Temat[5] *100;  #u- wind speed, convert m/s to cm/s
H_sdir=Temat[6]/10 #divide by ten to convert W/m2 to W/cm2
H_sdif=Temat[7]/10 #divide by ten to convert W/m2 to W/cm2
psi=Temat[8]
